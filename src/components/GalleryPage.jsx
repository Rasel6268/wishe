  ...
  const birthdayPhotos = [
    {
      ...
      backMessage:
        "হালকা পিচ্ছি, কিন্তু attention-grabbing!",
      title: "পিচ্ছি", 
    ...
    },
    {
      ...
      backMessage: "যেন আলোর মতো উজ্জ্বলতা ছড়িয়ে দেয় চারপাশে",
      title: "প্রফুল্লময়ী",
    ...
    },
    {
      ...
      backMessage:
        "আলোয় ভরা তার অস্তিত্ব,মধুর হাসি, দীপ্তিময় দুই নয়ন।বুদ্ধি আর সৌন্দর্যের অপূর্ব সমন্বয়,স্পর্শ করে মন শান্তির কয়েন।",
      title: "প্রভাময়ী",
    ...
    },
    {
      ...
      backMessage: "মৃদু চুপচাপ চোখে জ্ঞানের দীপ জ্বলে।",
      title: "জ্ঞানপ্রিয়া",
    ...
    },
    {
      ...
      backMessage: "সূর্য যখন হাসে, সৌন্দর্য তার কিরণে নাচে।",
      title: "সূর্যনন্দিনী",
    ...
    },
    {
      ...
      backMessage: "হৃদয়ময়ী চাহনি, মধুর হাসি বহন করে,প্রতিটি মুহূর্তে আলো ছড়িয়ে যায় তার পথ।",
      title: "চিরসুমধুরা",
      color: "from-red-500 to-pink-500",
    },
    {
      ...
      backMessage: "কানে ফুল, চুলে ঢেউ, চোখে কোমল আলো,ফুলকন্যা, যার হাসি ছড়িয়ে দেয় মধুরতা।",
      title: "পুষ্পময়ী",
      color: "from-red-500 to-pink-500",
    },
  ];
